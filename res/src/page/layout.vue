  ...
  <a-layout id="components-layout-demo-custom-trigger" style='height:100%'>
    <a-layout-sider v-model="collapsed" :trigger="null" collapsible>
      ...
      <a-menu theme="dark" mode="inline" :default-selected-keys="[$route.path]" @select='jumpTo'>
        <a-menu-item key="/admin/user/list">
          <a-icon type="user" />
          <span>用户管理</span>
        </a-menu-item>
        <a-menu-item key="/admin/goods/list">
          <a-icon type="user" />
          <span>集贸市场</span>
        </a-menu-item>
        <a-menu-item key="/admin/goods/public">
          <a-icon type="shopping" />
          <span>商品发布</span>
        </a-menu-item>
        <a-menu-item key="/admin/user/sell">
          <a-icon type="user" />
          <span>订单管理</span>
        </a-menu-item>
        <a-menu-item key="/admin/user/sell">
      ...
      <a-layout-header class='header'>
        <a-row type='flex' align='middle' justify='space-between'>
          ...
          <a-menu v-model="current" mode="horizontal" :default-selected-keys="[$route.path]" @click='jumpTo'>
            ...
            <a-menu-item key="alipay"> <a-icon type="question-circle" />
             帮助
            </a-menu-item>
          </a-menu>
