...
public interface OmOrderDao {
    ...
    @Select({"select o1.goods_id, buyer_id, g.image_url, g.name, g.type, g.price, o1.actual_pay_amount/g.price quantitySiOrder, o1.actual_pay_amount, o1.has_payed, o1.has_shipped, o1.has_confirmed\n" +
