...
public interface OmOrderDao {
    ...
    @Select("select o.id,g.image_url,g.name,o.buyer_name,o.buyer_phone,o.buyer_address,o.actual_pay_amount , o.has_shipped,o.has_confirmed,o.has_payed from om_order o,gm_goods g where g.user_id = #{sellerId} and o.goods_id = g.id")
    ...
    public List<BuyShow> queryByBuyerId(Integer buyerId, Integer hasPayed);
    ...
    @Select({
            "select o1.id, o1.goods_id, buyer_id, buyer_name, buyer_phone,g.user_id seller_id, g.image_url, g.name, g.type, g.price, o1.actual_pay_amount/g.price quantitySiOrder, o1.actual_pay_amount, o1.has_payed, o1.has_shipped, o1.has_confirmed\n"
                    + "from om_order o1, gm_goods g\n"
