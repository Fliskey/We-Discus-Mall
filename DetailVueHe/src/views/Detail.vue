...
<!--        <p class="intro">{{productDetails.product_intro}}</p>-->
        <h1 class="name">产品名称</h1>
        <p class="intro">产品数量</p>
        <p class="store">同学昵称</p>
        <div class="price">
...
export default {
  data() {
    return {
      carouseLIST:[
          require('../../public/imag/detailPage/1.jpg'),
          require('../../public/imag/detailPage/2.jpg')
      ],
